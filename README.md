...
* To remove nearly every package(application) without requiring root access.
    * **The advantages of removing these packages :**
        ...
        2.  No more spies from bloatwares(applications installed by device manufacturers).
...
# 1) To access the ADB shell, type :
...
# 8) To make an ADB backup, do the following :
...
### Did you like this project? What about purchasing a [coffee🍵](https://www.buymeacoffee.com/anupamjaiswall) for me?
